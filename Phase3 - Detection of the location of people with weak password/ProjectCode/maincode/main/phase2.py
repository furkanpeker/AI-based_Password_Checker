...
def fetchCredentials():
    ...
    ssh_session.connect(hostname = hostname, username = usernameOfPfsense, password = passwordOfPfsense, port = port)
...
''' Imports for phase 3 scrapy executer '''
from execution import script
